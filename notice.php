                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonexport"> 
                                 <a href="#" class="btn btn-add" data-toggle="modal" data-target="#addnot"><i class="fa fa-plus"></i> Add Notice</a>  
                              </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td><span class="label-custom label label-default">Published</span>
                                       </td>
                                       <td>
                                    ...
                                    <tr>
                                       ...
                                       <td>08-09-2017</td>
                                       <td>Monthly salary to be delay for uncircummostance</td>
                                       <td><span class="label-warning label label-default">pending</span>
                                       </td>
                                       <td>
                                          <button type="button" class="btn btn-add btn-xs" data-toggle="modal" data-target="#update"><i class="fa fa-pencil"></i></button>
                                          <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delt"><i class="fa fa-trash-o"></i> </button>
                                    ...
                                    <tr>
                                       ...
                                       <td><span class="label-danger label label-default">dely</span>
                                       </td>
                                       <td>
                                          <button type="button" class="btn btn-add btn-xs" data-toggle="modal" data-target="#update"><i class="fa fa-pencil"></i></button>
                                          <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delt"><i class="fa fa-trash-o"></i> </button>
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           ...
                           <h3><i class="fa fa-plus m-r-5"></i> add new notice</h3>
                        </div>
               ...
               <div class="modal fade" id="update" tabindex="-1" role="dialog">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                           <h3><i class="fa fa-plus m-r-5"></i> Update notice board</h3>
                        </div>
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
               ...
               <div class="modal fade" id="delt" tabindex="-1" role="dialog">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                           <h3><i class="fa fa-user m-r-5"></i> Delete Notice</h3>
                        </div>
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
