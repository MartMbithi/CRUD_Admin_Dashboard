         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Hourly calculation</h1>
                  <small>Hourly Details</small>
               </div>
            </section>
            <!-- Main content -->
            <section class="content">
                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport"> 
                                 <a href="#" class="btn btn-add" data-toggle="modal" data-target="#addhour"><i class="fa fa-plus"></i> Add Hour</a>  
                              </div>
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           ...
                           <h3><i class="fa fa-plus m-r-5"></i> Add Hour</h3>
                        </div>
                                 ...
                                 <form class="form-horizontal">
                                    <fieldset>
                                       <div class="col-md-6 form-group">
                                          <label class="control-label">Hourly Grades</label>
                                          <input type="text" placeholder="Hourly Grade" class="form-control">
                                       </div>
                                       <!-- Text input-->
                                       <div class="col-md-6 form-group">
                                          <label class="control-label">Hourly rates</label>
                                          <input type="text" placeholder="Hourly rates" class="form-control">
                                       </div>
               ...
               <!-- Modal -->    
               <!-- User Modal1 -->
               <div class="modal fade" id="addhour" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                           <h3><i class="fa fa-plus m-r-5"></i> Add Hour scale</h3>
                        </div>
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
               ...
               <div class="modal fade" id="customer2" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                           <h3><i class="fa fa-user m-r-5"></i> Delete Hour table</h3>
                        </div>
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <form class="form-horizontal">
                                    <fieldset>
                                       <div class="col-md-12 form-group user-form-group">
                                          <label class="control-label">Delete Hour table</label>
                                          <div class="pull-right">
