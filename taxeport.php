...
$aid=$_SESSION['admin_id'];
    if(isset($_POST['add_tax_report']))//get specific input from a certain button.
            {
                ...
                $query="insert into tax_reports (date, account, type, category, amount, description, credit, balance) values(?,?,?,?,?,?,?,?)";
                $stmt = $mysqli->prepare($query);
                //bind the submitted values with the matching columns in the database.
                $rc=$stmt->bind_param('ssssssss', $date, $account, $type, $category, $amount, $description, $credit, $balance);
                $stmt->execute();
                //if binding is successful, then indicate that a new value has been added.
                $success_msg= " Tax Report Details Added";
      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content">
                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonlist"> 
                                 <a class="btn btn-add" href="#" data-toggle="modal" data-target="#taxreport"> <i class="fa fa-plus"></i> Add Tax rates
                                 </a>  
                              </div>
               ...
               <!-- taxreport Modal1 -->
               <div class="modal fade" id="taxreport" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                           <h3><i class="fa fa-user m-r-5"></i>Create Tax Report</h3>
                        </div>
                                    ...
                                    <fieldset>
                                       ...
                                       <div class="col-md-12 form-group user-form-group">
                                          <div class="pull-right">
                                             ...
                                             <button type="submit" name="add_tax_report" class="btn btn-add btn-sm">Save</button>
                                          </div>
                                       </div>
                                    </fieldset>
                                 </form>
