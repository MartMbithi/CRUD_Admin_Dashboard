         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  ...
                  <small>Expense Management details</small>
               </div>
            </section>
            <!-- Main content -->
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>accommodation</td>
                                       <td>$ 1,965.00</td>
                                       <td><span class="label-custom label label-default">paid</span>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>bug 9854</td>
                                       ...
                                       <td>accommodation</td>
                                       <td>$ 1,965.00</td>
                                       <td><span class="label-danger label label-default">not pay</span>
                                       </td>
                                    </tr>
                                 </tbody>
                              </table>
