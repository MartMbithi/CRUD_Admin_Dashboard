...
if(isset($_POST['post_expense']))
{
   ...
   //sql to inset the values to the database
    $query="insert into expense (bank_account, posting_date, description, amount, type) values(?,?,?,?,'Expense')";
                  ...
                  <div class="col-sm-4">
                     <div class="panel lobidisable panel-bd">
                        ...
                        <form method="POST">
                              ...
                              <div class="form-group">
                                 <button type="submit" name="post_expense" class="btn btn-add"><i class="fa fa-check"></i> Submit
                                 </button>
                              </div>
                           </form>
                        </div>
                     ...
                     <div class="panel lobidisable panel-bd">
                        ...
                        <div class="panel-body">
                           ...
                           <table class="table table-bordered table-hover">
                                 ...
                                 $ret="SELECT * FROM `expense`  WHERE type = 'Expense' ";
